...
const ReportScreen = props => {
  ...
  const [labelsSet, setLabelSet] = React.useState({
    7: new Array(7).fill(1).map((item, index) => {
  ...
  const filteredBigNutrient = typeList.filter(item =>
    bigNutrient.includes(item.id),
  );
  ...
  const getSpecificationSuccess = response => {
    ...
    days.map((day, index) => {
      const d = data.find(res => {
        return res.insertDate.includes(
          moment()
            .subtract(dur - index - 1, 'days')
            .format('YYYY-MM-DD'),
        );
      });
      if (d) {
  ...
  return (
    <>
      ...
      <ScrollView contentContainerStyle={{alignItems: 'center'}}>
        <Text
          style={[styles.title, {fontFamily: lang.font}]}
            ...
            return (
              <TouchableOpacity
                style={{
                  ...
                  borderBottomWidth: selectedCat == item.id ? 2 : 0,
                }}
                onPress={() => onSelectedCat(item, index)}>
                <Text
                  style={{
                    color: selectedCat == item.id ? item.color : 'black',
            ...
            ? filteredBigNutrient.map((item, index) => {
                return (
                  <TouchableOpacity
                    ...
                    <Text
                      style={{
                        color: selectedItem == item.id ? color : 'black',
                        fontFamily: lang.font,
        ...
        <ScrollView
          ...
          <View
            ...
            <View
              ...
              <Text
                style={{fontSize: moderateScale(14), fontFamily: lang.font}}>
                {unit}
              </Text>
            </View>
            <LineChart
                ...
                return (
                  <Text
                    style={{
                      ...
                      width: dimensions.WINDOW_WIDTH * widthC,
                      paddingTop: r.y - 20,
                      paddingRight: Platform.OS == 'ios' ? r.x - 5 : 0,
                      paddingLeft: Platform.OS == 'android' ? r.x - 5 : 0,
                    }}>
                    {r.indexData}
                  </Text>
                );
          ...
          {durationList.map((item, index) => {
            return (
              <TouchableOpacity
                ...
                <Text
                  style={{
                    color: selectedWeek == item.name ? 'white' : 'black',
                    fontFamily: lang.font,
                    padding: moderateScale(9),
                    paddingHorizontal: moderateScale(20),
                    fontSize: moderateScale(15),
