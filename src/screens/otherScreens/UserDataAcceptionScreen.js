        ...
        <>
            <ScrollView contentContainerStyle={styles.mainContainer}>
                <View style={styles.headerContainer}>
                    <Text style={[styles.headerText, { fontFamily: lang.titleFont }]}>{lang.dataConfirmationHeader}</Text>
                </View>
                ...
                <UserData lang={lang} title={lang.weight} data={specification[0].weightSize} />
                <UserData lang={lang} title={lang.rateActivity2} data={activityRate} />
                {isShowingweekly &&
                    <UserData lang={lang} title={lang.golWeight} data={profile.targetWeight} />
                }
                {isShowingweekly &&
                    <UserData lang={lang} title={goalinWeek} data={profile.weightChangeRate} />
                }
                <UserData lang={lang} title={lang.mainGoal} data={goal} contaierStyle={{borderBottomWidth:0}}/>
