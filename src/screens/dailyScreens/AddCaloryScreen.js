        ...
        <>
            ...
            <ScrollView contentContainerStyle={{alignItems : "center"}}>
                ...
                >
                    ...
                    >
                        <TouchableOpacity style={{marginHorizontal : moderateScale(10)}} onPress={()=>setMeal({...meal,foodMeal : 0})}>
                            <Image
                                source={meal.foodMeal==0?require("../../../res/img/breakfast.png"):require("../../../res/img/breakfast2.png")}
                                style={styles.meal}
                                resizeMode="contain"
                            />
                        </TouchableOpacity>
                        <TouchableOpacity style={{marginHorizontal : moderateScale(10)}} onPress={()=>setMeal({...meal,foodMeal : 1})}>
                            <Image
                                source={meal.foodMeal==1?require("../../../res/img/lunch.png"):require("../../../res/img/lunch2.png")}
                                style={styles.meal}
                                resizeMode="contain"
                            />
                        </TouchableOpacity>
                        <TouchableOpacity style={{marginHorizontal : moderateScale(10)}} onPress={()=>setMeal({...meal,foodMeal : 3})}>
                            <Image
                                source={meal.foodMeal==3?require("../../../res/img/dinner.png"):require("../../../res/img/dinner2.png")}
                                style={styles.meal}
                                resizeMode="contain"
                            />
                        </TouchableOpacity>
                        <TouchableOpacity style={{marginHorizontal : moderateScale(10)}} onPress={()=>setMeal({...meal,foodMeal : 2})}>
                            <Image
                                source={meal.foodMeal==2?require("../../../res/img/snack.png"):require("../../../res/img/snack2.png")}
                                style={styles.meal}
                                resizeMode="contain"
                            />
                        </TouchableOpacity>
