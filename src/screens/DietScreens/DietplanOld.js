...
import { Calendar, MainToolbar, ConfirmButton, ChangePackageModal, DietCalendar, Information, Toolbar } from '../../components'
import moment from 'moment'
import { addAllSnack, addCheeteDay, addWeekSnack, calculatePercent, changeBreakfastAte, changeDinnerAte, changeDinnerData, changeLunchAte, changeLunchData, changeSnackAte, changeSnackData, clearDiet, addAllBreakFasts, addAllDinner, addAllLunch, addWeekBreakfast, addWeekDinner, addWeekLunch, changeData } from '../../redux/actions/dietOld'
...
// import { addAllSnack, addCheeteDay, addWeekSnack, calculatePercent, changeBreakfastAte, changeDinnerAte, changeDinnerData, changeLunchAte, changeLunchData, changeSnackAte, changeSnackData, clearDiet } from '../../redux/actions/dietNew'
...
import DietDailyOld from '../../components/dietComponents/dietDailyOld'
...
function DietPlan(props) {
    ...
    const renderItem = (item) => {
        return <DietDailyOld foodDB={foodDB} auth={auth} item={item} lang={lang} value={item.item.value} />
    }
