...
const MarketModal = props => {
    ...
    if (props.item) {
        return (
            <View style={{alignItems:"center",justifyContent:"center",width:dimensions.WINDOW_WIDTH,height:dimensions.WINDOW_HEIGTH,backgroundColor:"rgba(0,0,0,0.8)",position:"absolute"}}>
