...
const NutritionCard = props => {
  ...
  if (extraCalorie > 0) {
    inputCalorieWidth = barWidth * 0.75;
    burnedCalorieWidth = 0;
    extraCalorieWidth =
      extraCalorie / ((inputCalorie - burnedCalories) / (barWidth * 0.75));
  } else {
    ...
    if (inputCalorie - burnedCalories <= targetCalorie) {
      if (inputCalorie > burnedCalories) {
        inputCalorieWidth =
          ((inputCalorie - burnedCalories) / targetCalorie) * (barWidth * 0.75);
        burnedCalorieWidth = 0;
      } else {
        inputCalorieWidth = 0;
        burnedCalorieWidth = 0;
  ...
  return (
    <TouchableOpacity
      ...
      <View
        ...
        <View
          ...
          <View style={styles.burnedANDget}>
            <Text
              style={[
                styles.burnedAgetText,
                { fontFamily: props.lang.titleFont },
              ]}>
              {' '}
              {parseInt(burnedCalories) + parseInt(stepBurnedCalories)}{' '}
            </Text>
            <Text
              style={[
                styles.burnedAgetText,
          ...
          <View style={styles.burnedANDget}>
            <Fire width={moderateScale(20)} />
            <Text
              style={[
                styles.burnedAgetText,
                { fontFamily: props.lang.titleFont },
              ]}>
              {props.lang.burnedCalorie}
            </Text>
          </View>
        </View>
        <View
                ...
                {() => (
                  <View style={{ alignItems: 'center' }}>
                    <Text
                      ...
                      {parseInt(targetCalorie + burnedCalories - inputCalorie) <
                        0
                        ? parseInt(
                          targetCalorie + burnedCalories - inputCalorie,
                        ) * -1
                        : parseInt(
                          targetCalorie + burnedCalories - inputCalorie,
                        )}
                    ...
                    <Text
                      ...
                      {targetCalorie + burnedCalories - inputCalorie < 0
                        ? props.lang.overFlow
                        : props.lang.calorieRemain}
                    </Text>
                  </View>
                )}
              </AnimatedCircularProgress>
        ...
        <View
          ...
          <View style={styles.burnedANDget}>
            <Rice width={moderateScale(25)} />
            <Text
              style={[
                styles.burnedAgetText,
                { fontFamily: props.lang.titleFont },
              ]}>
              {props.lang.caloriecardfood}
            </Text>
          </View>
        </View>
      </View>
      ...
      <View style={{ flexDirection: 'row', alignItems: 'center' }}>
        <DowArrow width={moderateScale(20)} />
        <Text
          style={{
            fontFamily: props.lang.titleFont,
