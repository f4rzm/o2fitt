export const en =
{
    ...
    "pedometerAutoCounter":"Automatically sync your steps and distance with apple health",
    "pedometerPermissionDes":"Apple HealthKit permission needed!\nUsing steps and distance with the Apple Health app on iphone empowers you to better manage your burned calorie and health.\nwe need to use the data of apple health app.\nDo you want to allow this permission?",
    "distance":"the covered distance",
    "stepsDes":"Pedometer",
    "changeTimeSetting":"Adjust date",
    "timeZoneHeader":"Update your time zone",
    "timeZoneDes":"The time and date of your phone is behind or ahead of the current time. Please click on the link below to go to the settings section of your phone and set the calendar and clock to automatic mode.",
